...
export default function ManagerPage() {
  ...
  const profileTrigger = (
    <div className="fixed bottom-4 right-4 z-[9999]">
      <button
        ...
        className="p-2 rounded-full border-[4px] border-blue-600 bg-white dark:bg-black hover:scale-105 transition-transform"
      >
  ...
  const profileDrawer = (
    ...
    >
      ...
      <div className="p-4 space-y-4 text-sm">
        <p>Coming soon: manager settings and privilege tools.</p>
      </div>
    </div>
  )
  ...
  return (
    <main className="flex flex-col items-center justify-center px-4 py-8 space-y-6 bg-white dark:bg-gray-900 text-black dark:text-white min-h-screen">
      <h1 className="text-2xl font-bold mb-2">Manager Testing Dashboard</h1>
